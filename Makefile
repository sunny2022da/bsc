...
.PHONY: geth faucet debug-fusion all test truffle-test lint fmt clean devtools help
.PHONY: docker
...
#? debug-fusion: Build debug-fusion tool.
debug-fusion:
	$(GORUN) build/ci.go install ./cmd/debug-fusion
	@echo "Done building debug-fusion"
