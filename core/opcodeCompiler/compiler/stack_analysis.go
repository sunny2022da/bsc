		...
		for _, succ := range succs {
			...
			if !seen {
				...
				if oldH != exitH {
					...
					return nil, fmt.Errorf("stack height mismatch at block %d (pc %d): existing %d, incoming %d", succ.blockNum, succ.firstPC, oldH, exitH)
				}
			}
		}
	}
	...
	for pc < len(code) {
		...
		if pc > int(bb.firstPC) {
			if _, isStart := c.pcToBlock[uint(pc)]; isStart {
				return delta, -minH, lastOp, pc, nil
			}
		}
...
func getOpStackDelta(op ByteCode) (pops, pushes int) {
	...
	case ADD, MUL, SUB, DIV, SDIV, MOD, SMOD, EXP, SIGNEXTEND: return 2, 1
	case ADDMOD, MULMOD: return 3, 1
	case LT, GT, SLT, SGT, EQ, AND, OR, XOR, BYTE, SHL, SHR, SAR: return 2, 1
	case ISZERO, NOT: return 1, 1
	case KECCAK256: return 2, 1
	case ADDRESS: return 0, 1
	case BALANCE: return 1, 1
	case ORIGIN, CALLER: return 0, 1
	case CALLVALUE: return 0, 1
	case CALLDATALOAD: return 1, 1
	case CALLDATASIZE: return 0, 1
	case CALLDATACOPY: return 3, 0
	case CODESIZE: return 0, 1
	case CODECOPY: return 3, 0
	case GASPRICE: return 0, 1
	case EXTCODESIZE: return 1, 1
	case EXTCODECOPY: return 4, 0
	case RETURNDATASIZE: return 0, 1
	case RETURNDATACOPY: return 3, 0
	case EXTCODEHASH: return 1, 1
	case BLOCKHASH: return 1, 1
	case COINBASE: return 0, 1
	case TIMESTAMP: return 0, 1
	case NUMBER: return 0, 1
	case DIFFICULTY: return 0, 1 // RANDOM
	case GASLIMIT: return 0, 1
	case CHAINID: return 0, 1
	case SELFBALANCE: return 0, 1
	case BASEFEE: return 0, 1
	case BLOBHASH: return 1, 1
	case BLOBBASEFEE: return 0, 1
	case POP: return 1, 0
	case MLOAD: return 1, 1
	case MSTORE: return 2, 0
	case MSTORE8: return 2, 0
	case SLOAD: return 1, 1
	case SSTORE: return 2, 0
	case JUMP: return 1, 0
	case JUMPI: return 2, 0
	case PC, MSIZE, GAS: return 0, 1
	case JUMPDEST: return 0, 0
	case TLOAD: return 1, 1
	case TSTORE: return 2, 0
	case MCOPY: return 3, 0
	case PUSH0: return 0, 1
	// PUSH1-32 handled by caller
	case DUP1: return 1, 2
	case DUP2: return 2, 3
	case DUP3: return 3, 4
	case DUP4: return 4, 5
	case DUP5: return 5, 6
	case DUP6: return 6, 7
	case DUP7: return 7, 8
	case DUP8: return 8, 9
	case DUP9: return 9, 10
	case DUP10: return 10, 11
	case DUP11: return 11, 12
	case DUP12: return 12, 13
	case DUP13: return 13, 14
	case DUP14: return 14, 15
	case DUP15: return 15, 16
	case DUP16: return 16, 17
	case SWAP1: return 2, 2
	case SWAP2: return 3, 3
	case SWAP3: return 4, 4
	case SWAP4: return 5, 5
	case SWAP5: return 6, 6
	case SWAP6: return 7, 7
	case SWAP7: return 8, 8
	case SWAP8: return 9, 9
	case SWAP9: return 10, 10
	case SWAP10: return 11, 11
	case SWAP11: return 12, 12
	case SWAP12: return 13, 13
	case SWAP13: return 14, 14
	case SWAP14: return 15, 15
	case SWAP15: return 16, 16
	case SWAP16: return 17, 17
	case LOG0: return 2, 0
	case LOG1: return 3, 0
	case LOG2: return 4, 0
	case LOG3: return 5, 0
	case LOG4: return 6, 0
	case CREATE: return 3, 1
	case CALL: return 7, 1
	case CALLCODE: return 7, 1
	case RETURN: return 2, 0
	case DELEGATECALL: return 6, 1
	case CREATE2: return 4, 1
	case STATICCALL: return 6, 1
	case REVERT: return 2, 0
	case INVALID: return 0, 0
	case SELFDESTRUCT: return 1, 0
	default:
		return 0, 0
	}
}
